            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <a href="./Tours-Pakages-in-Uttarakhnad.php" class="custom-block-image-wrap">

                            <h4 class="section-title">Our Tour Packages</h4>
                        </a>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-12  mt-4 mb-4 mb-lg-0">
                            ...
                            <div class="custom-block  custom-block-full">
                                ...
                                <div class="custom-block-info">
                                    ...
                                    <div class="profile-block d-flex">
                                        <p> <strong> Location included in package</strong>

                                            <?php foreach ($Tour1["locations"] as $tourLocations) { ?>
                                                <a href= <?php echo "'". $tourLocations['pageLink'] ."'" ?>>
                                                <?php echo $tourLocations['location'] ?> </a>,
                                            <?php } ?>
                                        </p>
                                    </div>
                                    <a href=<?php echo $Tour1['pageLink'] ?> class="btn custom-btn smoothscroll w-100 mt-3">More Details</a>
                                    <a href="https://wa.link/7oobtn" class="btn custom-btn smoothscroll w-100 mt-3">Contact Now</a>
