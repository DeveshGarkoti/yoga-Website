                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="section-title-wrap mb-5">
                            <h4 class="section-title">Our Hotels in <?php echo $location1['location'] ?></h4>
                        </div>
                    </div>

                    <?php foreach ($location1['hotels'] as $hotel) { ?>

                        <div class="col-lg-4 col-12  mt-4 mb-2 mb-lg-0">
