<section class="topics-section section-padding  pb-0" id="section_3">
    <div class="container">
        <div class="row">
            ...
            <?php foreach ($hotel1['thingsToDo'] as $thingsToDO) { ?>

                <div class="col-lg-3 col-md-6 col-12 mt-2 mb-2 mb-lg-0">
                    <div class="custom-block custom-block-overlay">
                        <div class="wowload fadeInUp">
                            <a href=<?php echo $thingsToDO['image'] ?> title=<?php echo '"' . $thingsToDO['name'] . '"' ?> alt=<?php echo '"' . $thingsToDO['name'] . '"' ?> class="col-12" data-gallery>
